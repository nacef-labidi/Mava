...
"""Behaviour Cloning system builder implementation."""
...
from mava.systems.tf.offline.bc import execution, training
...
class BCBuilder:
    """Builder for Behaviour Cloning which constructs components of the system."""

    def __init__(
        self,
        config: BCConfig,
        trainer_fn: Type[training.BCTrainer] = training.BCTrainer,
        executor_fn: Type[core.Executor] = execution.BCFeedForwardExecutor,
    ...
    def make_executor(
        ...
        Args:
            networks: networks in the system.
        ...
        if variable_source:
            ...
            variables = {
                net_key: networks[net_key].variables
