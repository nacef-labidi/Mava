...
from mava.systems.tf.offline.bc import builder, execution, training
...
class BC:
    ...
    def __init__(
        ...
        Args:
            ...
            network_factory: function to create system networks.
        ...
        # Make the builder
        self._builder = builder.BCBuilder(
            builder.BCConfig(
    ...
    def build(self, name: str = "bc") -> Any:
        """Build the distributed system as a graph program.

        Args:
            name (str, optional): system name. Defaults to "bc".
